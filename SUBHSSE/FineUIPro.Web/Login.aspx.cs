namespace FineUIPro.Web
{
    ...
    public partial class Login : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
               // string bb= Funs.EncryptionPassword("1krl9co4h"); 
               // string a = "1306465901719805954sdgcyxgs@CNCEC199C1ADFDADC37B426FC3DC7E573378D2020-11-30 16:40:00";
               //string aa = Funs.EncryptionPassword(a);
