            ...
            <Toolbars>
                <f:Toolbar ID="Toolbar1" Position="Top" runat="server">
                    <Items>
                        ...
                        <f:Button ID="btnSave" Text="保存条件" Icon="TableSave" runat="server" OnClick="btnSave_Click"
                            ValidateForms="Toolbar1">
                        </f:Button>
                        <f:Button ID="btnBuild" Text="生成试卷" Icon="tick" runat="server" OnClick="btnBuild_Click">
                        </f:Button>
                        <f:Button ID="btnDelete" Text="删除试卷" Icon="Delete" ConfirmText="确定删除当前数据？" OnClick="btnDelete_Click"
