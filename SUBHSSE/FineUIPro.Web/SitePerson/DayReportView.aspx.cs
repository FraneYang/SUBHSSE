    ...
    public partial class DayReportView : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (this.nowData == "-1")
                {
                   var  dayReport = Funs.DB.SitePerson_DayReport_Bak.FirstOrDefault(x => x.DayReportId == this.DayReportId);
                    if (dayReport != null)
                    {
        ...
        private void BindGrid()
        {
            ...
            if (this.nowData == "-1")
            {
                var q = from x in db.SitePerson_DayReportDetail_Bak
                        join a in db.SitePerson_DayReport_Bak
                        ...
                        select new
                        {
                            ...
                            x.RealPersonNum,
                            x.PersonWorkTime,
                            YearPersonWorkTime = (from y in db.SitePerson_DayReportDetail_Bak
                                                  where (from z in db.SitePerson_DayReport_Bak
                            ...
                            TotalPersonWorkTime = (from y in db.SitePerson_DayReportDetail_Bak
                                                   where (from z in db.SitePerson_DayReport_Bak
