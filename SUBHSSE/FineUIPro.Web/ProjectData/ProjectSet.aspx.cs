...
namespace FineUIPro.Web.ProjectData
{
    public partial class ProjectSet : PageBase
    {
        ...
        private void BindGrid()
        {
            ...
            /// 是否本单位 人员
            if (!string.IsNullOrEmpty(this.CurrUser.UnitId) &&  !CommonService.GetIsThisUnit(this.CurrUser.UnitId)) 
            {
                strSql += " AND Project.UnitId = @TUnitId";
                listStr.Add(new SqlParameter("@TUnitId", this.CurrUser.UnitId));
            }
