<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckStatistics.aspx.cs"
    Inherits="FineUIPro.Web.DataStatistics.CheckStatistics" %>
            ...
            <Items>
                <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="安全检查统计" EnableCollapse="true"
                    ...
                    <Columns>
                        ...
                        <f:RenderField Width="260px" ColumnID="DataAllName" DataField="DataAllName" FieldType="String"
                            HeaderText="项目" TextAlign="Left" HeaderTextAlign="Center">
                        </f:RenderField>
                        <f:RenderField Width="230px" ColumnID="DataName" DataField="DataName" FieldType="String"
