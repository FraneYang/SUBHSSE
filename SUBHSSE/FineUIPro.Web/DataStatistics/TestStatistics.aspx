<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestStatistics.aspx.cs"
    Inherits="FineUIPro.Web.DataStatistics.TestStatistics" %>
            ...
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="考试统计" EnableCollapse="true"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            ...
                            <f:DropDownList runat="server" ID="drpTrainType" Label="培训类型" EnableEdit="true" LabelWidth="80px" Width="200px">
                            </f:DropDownList>                            
                        </Items>
                        </f:Toolbar>
                <f:Toolbar ID="Toolbar1" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            ...
                            <f:DropDownList runat="server" ID="drpPassName" Label="是否及格" LabelWidth="80px" Width="180px">                                
                                <f:ListItem Value="1" Text="是"/>
                                <f:ListItem Value="0" Text="否"/>
                            </f:DropDownList>
                              <f:DropDownList runat="server" ID="drpIsTest" Label="是否考试" LabelWidth="50px" Width="180px">                                
                                <f:ListItem Value="1" Text="是"/>
                                <f:ListItem Value="0" Text="否"/>
                            </f:DropDownList>
                ...
                <Columns>
                    ...
                    <f:RenderField Width="180px" ColumnID="ProjectName" DataField="ProjectName"  FieldType="String" 
                    ...
                    <f:RenderField Width="100px" ColumnID="TestStartTime" DataField="TestStartTime" 
                        FieldType="Date" Renderer="Date" HeaderText="考试时间"
                        HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="120px" ColumnID="TestScores" DataField="TestScores"  FieldType="String" 
                        HeaderText="成绩" TextAlign="Left" HeaderTextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="120px" ColumnID="PassName" DataField="PassName"  FieldType="String" 
                        HeaderText="是否及格" TextAlign="Left" HeaderTextAlign="Center">
                    </f:RenderField>                   
                </Columns>
                <PageItems>
