...
{
    public partial class MeetStatistics : PageBase
    {
        /// <summary>
        /// 项目id
        /// </summary>
        ...
        {
            var getDatas= DataStatisticsService.MeetStatistics(this.rbType.SelectedValue, this.drpCompany.SelectedValue, this.drpProject.SelectedValue,this.drpUnit.SelectedValue,Funs.GetNewDateTime(this.txtStartTime.Text), Funs.GetNewDateTime(this.txtEndTime.Text));
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode("安全会议统计" + filename, System.Text.Encoding.UTF8) + ".xls");
