...
{
    public partial class TrainingTestStatistics : PageBase
    {
        /// <summary>
        /// 项目id
        /// </summary>
        ...
        private void BindGrid()
        {
            ...
            if (this.drpType.SelectedValue != Const._Null && !string.IsNullOrEmpty(this.drpType.SelectedValue))
            {
                IsProject = this.drpType.SelectedValue;
            }
            string type = this.rbType.SelectedValue;
            ...
            SqlParameter[] parameter = new SqlParameter[]
                    ...
                    new SqlParameter("@EndTime", !string.IsNullOrEmpty(this.txtEndTime.Text)?this.txtEndTime.Text:null),
                     ...
                     new SqlParameter("@thisunitId", thisunitId),
                    };
            DataTable tb = SQLHelper.GetDataTableRunProc("SpTrainingTestStatistics", parameter);
            // 2.获取当前分页数据
