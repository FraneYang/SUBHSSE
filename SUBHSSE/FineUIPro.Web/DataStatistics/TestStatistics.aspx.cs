    ...
    public partial class TestStatistics : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Funs.FineUIPleaseSelect(this.drpPassName);
                Funs.FineUIPleaseSelect(this.drpIsTest);
        ...
        private void BindGrid()
        {
            ...
            if (this.drpPassName.SelectedValue != Const._Null && !string.IsNullOrEmpty(this.drpPassName.SelectedValue))
            {
                PassName = this.drpPassName.SelectedValue;
            }
            string IsTest = null;
            if (this.drpIsTest.SelectedValue != Const._Null && !string.IsNullOrEmpty(this.drpIsTest.SelectedValue))
            {
                IsTest = this.drpIsTest.SelectedValue;
            }
            SqlParameter[] parameter = new SqlParameter[]
                    ...
                    new SqlParameter("@EndTime", !string.IsNullOrEmpty(this.txtEndTime.Text)?this.txtEndTime.Text:null),
                     new SqlParameter("@PassName", PassName),
                      new SqlParameter("@IsTest", IsTest),
                    new SqlParameter("@PersonName", !string.IsNullOrEmpty(this.txtPersonName.Text)?this.txtPersonName.Text:null),
                    };
            DataTable tb = SQLHelper.GetDataTableRunProc("SpTestStatisticsStatistic", parameter);
            // 2.获取当前分页数据
