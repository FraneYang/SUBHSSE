            ...
            if (!IsPostBack)
            {
                ...
                if (!string.IsNullOrEmpty(this.AccidentCauseReportId))
                {
                    ...
                    if (q != null)
                    {
                        ...
                        var getMont = ConstValue.GetConstByConstValueAndGroupId(q.Month.ToString(), BLL.ConstValue.Group_0009);
                        if (getMont != null)
                        {
                            this.lbMonth1.Text = getMont.ConstText;
                            this.lbMonth2.Text = getMont.ConstText;
                            this.lbMonth3.Text = getMont.ConstText;
                        }
