<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccidentCauseReportEdit.aspx.cs"
    Inherits="FineUIPro.Web.InformationProject.AccidentCauseReportEdit" ValidateRequest="false" %>
            ...
            <f:FormRow ColumnWidths="30% 12% 10% 10% 5% 5% 28%">
                <Items>
                    ...
                    <f:Label ID="Label2" runat="server" Text="职工伤亡事故原因分析">
                      ...
                      <f:DropDownList ID="drpYear"  EnableSimulateTree="true" Required="true"
           ...
           <f:FormRow ColumnWidths="10% 5% 11% 7% 6%">
            ...
            <f:FormRow>
                <Items>
                    ...
                    <f:DatePicker runat="server" Label="填报日期" ID="txtCompileDate" LabelAlign="Right"
                        EnableEdit="true">
                    </f:DatePicker>
                </Items>
            </f:FormRow>
