<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthlyRatingView.aspx.cs"
    Inherits="FineUIPro.Web.SafetyActivities.MonthlyRatingView" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <title>编辑月度安全评比</title>
    <link href="../res/css/common.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">
    <f:PageManager ID="PageManager1" runat="server" AutoSizePanelID="SimpleForm1"/>
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" Title="月度安全评比" AutoScroll="true"
