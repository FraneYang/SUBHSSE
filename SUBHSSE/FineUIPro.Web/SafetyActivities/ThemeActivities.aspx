<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ThemeActivities.aspx.cs" Inherits="FineUIPro.Web.SafetyActivities.ThemeActivities" %>
        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
            <Items>
                ...
                <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                    ...
                    <Items>
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="主题安全活动" EnableCollapse="true"
                            runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="ThemeActivitiesId"
                            DataIDField="ThemeActivitiesId" AllowSorting="true" ForceFit="true"
                            ...
                            <Columns>
                                ...
                                <f:WindowField TextAlign="Left" Width="60px" WindowID="WindowAtt" HeaderText="附件" Text="附件" ToolTip="附件上传查看"
                                    DataIFrameUrlFields="ThemeActivitiesId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&type=-1&path=FileUpload/ThemeActivitiesAttachUrl&menuId=9D04CD8B-575C-4854-B8B0-F90CEEB75815"
