...
{
    public partial class SafetyMonth : PageBase
    {
        #region 定义项
        /// <summary>
        /// 主键
        ...
        {
            string strSql = @"SELECT T.SafetyMonthId,T.ProjectId,T.Title,T.CompileDate,Users.UserName AS CompileManName,T.Remark,T.AttachUrl,T.SeeFile"
                          + @" FROM SafetyActivities_SafetyMonth AS T "
        ...
        {
            PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("SafetyMonthEdit.aspx?UnitId={0}", this.UnitId, "新增 - ")));
        }
        ...
        private void EditData()
        {
            ...
            {
                PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("SafetyMonthView.aspx?SafetyMonthId={0}", Grid1.SelectedRowID, "查看 - ")));
            }
            else
            {
                PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("SafetyMonthEdit.aspx?SafetyMonthId={0}", Grid1.SelectedRowID, "编辑 - ")));
            }
        }
        #endregion
        ...
        private void GetButtonPower()
        {
            ...
            string menuId = !string.IsNullOrEmpty(this.CurrUser.LoginProjectId) ? Const.ProjectSafetyMonthMenuId : Const.ServerSafetyMonthMenuId;
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode("全国安全月活动" + filename, System.Text.Encoding.UTF8) + ".xls");
