<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SafetyMonth.aspx.cs" Inherits="FineUIPro.Web.SafetyActivities.SafetyMonth"
        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
            <Items>
                ...
                <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                    ...
                    <Items>
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="全国安全月" EnableCollapse="true"
                            runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="SafetyMonthId"
                            DataIDField="SafetyMonthId" AllowSorting="true" ForceFit="true"
                            ...
                            <Columns>
                                ...
                                <f:WindowField TextAlign="Left" Width="60px" WindowID="WindowAtt" HeaderText="附件" Text="附件" ToolTip="附件上传查看"
                                    DataIFrameUrlFields="SafetyMonthId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&type=-1&path=FileUpload/SafetyMonthAttachUrl&menuId=71DA0222-1509-4154-AB39-8E88769C043C"
