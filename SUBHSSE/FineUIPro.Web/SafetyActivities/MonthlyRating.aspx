<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthlyRating.aspx.cs" Inherits="FineUIPro.Web.SafetyActivities.MonthlyRating"
        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
            <Items>
                ...
                <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                    ...
                    <Items>
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="月度安全评比" EnableCollapse="true"
                            runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="MonthlyRatingId"
                            DataIDField="MonthlyRatingId" AllowSorting="true" ForceFit="true"
                            ...
                            <Columns>
                                ...
                                <f:WindowField TextAlign="Left" Width="60px" WindowID="WindowAtt" HeaderText="附件" Text="附件" ToolTip="附件上传查看"
                                    DataIFrameUrlFields="MonthlyRatingId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&type=-1&path=FileUpload/MonthlyRatingAttachUrl&menuId=293FD782-7B39-4F0F-A826-CA790A70CCC7"
