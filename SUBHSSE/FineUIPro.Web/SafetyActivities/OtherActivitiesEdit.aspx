<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherActivitiesEdit.aspx.cs"
    Inherits="FineUIPro.Web.SafetyActivities.OtherActivitiesEdit" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <title>编辑其他安全活动</title>
    <link href="../res/css/common.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">
    <f:PageManager ID="PageManager1" runat="server" AutoSizePanelID="SimpleForm1"/>
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" Title="其他安全活动" AutoScroll="true"
