...
namespace FineUIPro.Web.SafetyActivities
{
    public partial class ThemeActivities : PageBase
    {
        ...
        {
            string strSql = @"SELECT T.ThemeActivitiesId,T.ProjectId,T.Title,T.CompileDate,Users.UserName AS CompileManName,T.Remark,T.AttachUrl,T.SeeFile"
                          + @" FROM SafetyActivities_ThemeActivities AS T "
