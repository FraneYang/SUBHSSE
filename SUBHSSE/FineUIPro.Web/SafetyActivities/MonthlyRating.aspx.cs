...
{
    public partial class MonthlyRating : PageBase
    {
        #region 定义项
        /// <summary>
        /// 主键
        ...
        {
            string strSql = @"SELECT T.MonthlyRatingId,T.ProjectId,T.Title,T.CompileDate,Users.UserName AS CompileManName,T.Remark,T.AttachUrl,T.SeeFile"
                          + @" FROM SafetyActivities_MonthlyRating AS T "
        ...
        {
            PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("MonthlyRatingEdit.aspx?UnitId={0}", this.UnitId, "新增 - ")));
        }
        ...
        private void EditData()
        {
            ...
            {
                PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("MonthlyRatingView.aspx?MonthlyRatingId={0}", Grid1.SelectedRowID, "查看 - ")));
            }
            else
            {
                PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("MonthlyRatingEdit.aspx?MonthlyRatingId={0}", Grid1.SelectedRowID, "编辑 - ")));
            }
        }
        #endregion
        ...
        private void GetButtonPower()
        {
            ...
            string menuId = !string.IsNullOrEmpty(this.CurrUser.LoginProjectId) ? Const.ProjectMonthlyRatingMenuId : Const.ServerMonthlyRatingMenuId;
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode("月度安全评比" + filename, System.Text.Encoding.UTF8) + ".xls");
