                ...
                <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                    ...
                    <Items>
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="119消防活动" EnableCollapse="true"
                            ...
                            DataIDField="FireActivitiesId" AllowSorting="true" ForceFit="true"
                            ...
                            <Columns>
                                ...
                                <f:WindowField TextAlign="Left" Width="60px" WindowID="WindowAtt" HeaderText="附件" Text="附件" ToolTip="附件上传查看"
                                    DataIFrameUrlFields="FireActivitiesId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&type=-1&path=FileUpload/FireActivitiesAttachUrl&menuId=58F5A99C-8104-459F-8934-54C30EE972AA"
