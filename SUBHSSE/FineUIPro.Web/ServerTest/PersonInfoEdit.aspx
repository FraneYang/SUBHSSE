<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonInfoEdit.aspx.cs" Inherits="FineUIPro.Web.ServerTest.PersonInfoEdit" %>
        ...
        <Items>
            <f:Panel ID="Panel2" runat="server" ShowBorder="false" ShowHeader="false" Layout="HBox"
                ...
                <Items>
                    <f:Panel ID="Panel1" Title="面板1" BoxFlex="5" MarginRight="5px" runat="server" ShowBorder="false"
                        ShowHeader="false">
                        <Items>
                            <f:TextBox ID="txtPersonName" runat="server" Label="姓名" MaxLength="200" LabelAlign="Right"
                            ...
                            <f:TextBox ID="txtUnitName" runat="server" Label="单位" LabelAlign="Right" Readonly="true" ></f:TextBox>                                            
                            <f:TextBox ID="txtAddress" runat="server" Label="家庭地址" MaxLength="50" LabelAlign="Right">
                            </f:TextBox>
                            <f:DropDownList ID="drpDepart" runat="server" Label="部门" LabelAlign="Right" EnableEdit="true">
                            </f:DropDownList>
                            <f:DropDownList ID="drpTitle" runat="server" Label="职称" LabelAlign="Right" EnableEdit="true">
                            </f:DropDownList>                        
                        </Items>
                    </f:Panel>
                    <f:Panel ID="Panel4" runat="server" BoxFlex="3" ShowBorder="false" ShowHeader="false"
                        ...
                        <Items>
                            ...
                            <f:DropDownList ID="drpPost" runat="server" Label="岗位" LabelAlign="Right" Required="True" ShowRedStar="True" EnableEdit="true">
                            </f:DropDownList>
                            <f:TextBox ID="txtTelephone" runat="server" Label="电话" LabelAlign="Right" MaxLength="50">
                            </f:TextBox>
                              <f:DropDownList runat="server" ID="drpLanguages" Label="语种">
                                <f:ListItem Value="Chinese" Text="中文" Selected="true"/>
                                <f:ListItem Value="English" Text="English"/>
                                <f:ListItem Value="Russian" Text="Русский язык"/>
                            </f:DropDownList>                       
                        </Items>
                    </f:Panel>
            ...
            <f:Form ID="Form7" ShowBorder="false" ShowHeader="false" runat="server">
                <Rows>
                    ...
                    <f:FormRow>
                        <Items>
                               <f:DropDownList ID="drpAuditor" runat="server" Label="审核人" LabelAlign="Right" 
                                   EnableEdit="true" ShowRedStar="true">
                            </f:DropDownList>
