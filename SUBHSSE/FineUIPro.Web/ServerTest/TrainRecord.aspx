<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainRecord.aspx.cs" Inherits="FineUIPro.Web.ServerTest.TrainRecord" %>
                ...
                <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="培训记录" EnableCollapse="true"
                    ...
                    <Columns>
                      <f:TemplateField ColumnID="tfNumber" Width="50px" HeaderText="序号" HeaderTextAlign="Center"
                        ...
                        <f:TemplateField ColumnID="tfUnitIds" Width="260px" HeaderText="单位名称" HeaderTextAlign="Center" ExpandUnusedSpace="true"
                            TextAlign="left">
                            <ItemTemplate>
                        ...
                        <f:RenderField Width="80px" ColumnID="TrainPersonNum" DataField="TrainPersonNum"
                            FieldType="Int" HeaderText="人数" HeaderTextAlign="Center"
                            TextAlign="Center">
                        </f:RenderField>
                    </Columns>
                    <Listeners>
