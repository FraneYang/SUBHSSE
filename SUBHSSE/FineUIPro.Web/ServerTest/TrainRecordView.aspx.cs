    ...
    public partial class TrainRecordView : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                var trainRecord = BLL.EduTrain_TrainRecordService.GetTrainRecordByTrainRecordId(this.TrainingId);
                if (trainRecord != null)
                {
        ...
        {           
            PageContext.RegisterStartupScript(Window2.GetShowReference(String.Format("~/EduTrain/TrainTest.aspx?TrainingId={0}", this.TrainingId, "查看 - ")));
        }
        ...
        protected void btnMenuView_Click(object sender, EventArgs e)
        {
            if (Grid1.SelectedRowIndexArray.Length > 0)
            {
                foreach (int rowIndex in Grid1.SelectedRowIndexArray)
                {
                    ...
                    PageContext.RegisterStartupScript(Window2.GetShowReference(String.Format("~/EduTrain/TrainTestView.aspx?TrainDetailId={0}", rowID, "查看试卷 - ")));
                }
            }
        }
