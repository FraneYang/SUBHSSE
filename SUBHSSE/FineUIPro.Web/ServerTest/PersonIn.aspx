<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonIn.aspx.cs" Inherits="FineUIPro.Web.ServerTest.PersonIn" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
                    ...
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true" runat="server"
                        ...
                        <Columns>
                            ...
                            <f:RenderField Width="120px" ColumnID="DepartName" DataField="DepartName" SortField="DepartName"
                                FieldType="String" HeaderText="部门" HeaderTextAlign="Center" TextAlign="Center">
                            </f:RenderField>
                            <f:RenderField Width="90px" ColumnID="WorkPostName" DataField="WorkPostName" SortField="WorkPostName"
            ...
            <f:FormRow>
                <Items>
                    <f:Label ID="lblBottom" runat="server" Text="说明：1 人员信息导入模板中，灰色项为必填项。2 身份证号码必须为15或18位，所属单位、岗位、特岗证书等必须与基础信息中对应类型的名称一致,否则无法导入。3 如需修改已有人员信息，请到系统中修改。4 数据导入后，点击“保存”，即可完成人员信息导入。">
                    </f:Label>
                </Items>
            </f:FormRow>
        </Rows>
