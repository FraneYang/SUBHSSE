<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonInProject.aspx.cs" Inherits="FineUIPro.Web.ServerTest.PersonInProject" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            <f:FormRow>
                <Items>
                    <f:DropDownList ID="drpProject" runat="server" Label="项目" EnableEdit="true" Required="true"
                        ShowRedStar="true" AutoPostBack="true" OnSelectedIndexChanged="TextBox_TextChanged">
                    </f:DropDownList>
                     <f:DatePicker ID="txtChangeTime" runat="server" Label="入场时间" EnableEdit="true" ShowRedStar="true" Required="true">
                    </f:DatePicker> 
                </Items>
            </f:FormRow>
            <f:FormRow>
