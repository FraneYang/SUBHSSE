<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonUnitRefresh.aspx.cs" Inherits="FineUIPro.Web.ServerTest.PersonUnitRefresh" %>
                   ...
                   <f:DropDownBox runat="server" ID="drpPerson" Label="现场人员" EmptyText="请从下拉表格中选择" MatchFieldWidth="false" LabelAlign="Right"
                        ...
                        <PopPanel>
                            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" runat="server" DataIDField="PersonId" DataTextField="PersonName"
                                ...
                                Hidden="true" Width="600px" Height="380px" EnableMultiSelect="true" KeepCurrentSelection="true" 
                                EnableCheckBoxSelect="True" PageSize="10000" ForceFit="true">
                                <Toolbars>
                                ...
                                <Columns>
                                    ...
                                    <f:RenderField Width="120px" ColumnID="CardNo" DataField="CardNo" EnableFilter="true"
                                    ...
                                    <f:RenderField Width="250px" ColumnID="IdentityCard" DataField="IdentityCard" SortField="IdentityCard" FieldType="String"
