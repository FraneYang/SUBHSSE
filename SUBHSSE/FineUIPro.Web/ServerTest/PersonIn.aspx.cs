...
namespace FineUIPro.Web.ServerTest
{
    public partial class PersonIn : PageBase
    {
                ...
                {                   
                    ...
                    if (!string.IsNullOrEmpty(col1))
                    {
                        ...
                        if (!string.IsNullOrEmpty(col3))
                        {
                            ...
                            if (PersonService.GetPersonCountByIdentityCard(col3, null) != null)
                            {
                        ...
                        {
                            var depart = departs.FirstOrDefault(e => e.DepartName == col6);
                            if (depart == null)
                            {
                                result += "第" + (i + 2).ToString() + "行," + "部门" + "," + "[" + col6 + "]错误！" + "|";
                            }
                        }
                        ...
                        {
                            var post = posts.FirstOrDefault(e => e.WorkPostName == col7);
                            if (post == null)
                            {
                                result += "第" + (i + 2).ToString() + "行," + "岗位" + "," + "[" + col7 + "]错误！" + "|";
                            }
                        }
                        else
                        {
                        ...
                        {
                            var certificate = certificates.FirstOrDefault(e => e.CertificateName == col8);
                            if (certificate == null)
                            {
                                result += "第" + (i + 2).ToString() + "行," + "特岗证书" + "," + "[" + col8 + "]错误！" + "|";
                            }
                        }
                        ...
                        if (!string.IsNullOrEmpty(col10))
                        {
                            try
                            {
                                DateTime date = Convert.ToDateTime(col10);
                            }
                            catch (Exception)
                            {
                                result += "第" + (i + 2).ToString() + "行," + "证书有效期" + "," + "[" + col10 + "]错误！" + "|";
                            }
                        }
                    }
                }
            ...
            if (pds != null && ir > 0)
            {
                ...
                for (int i = 0; i < ir; i++)
                {
                    ...
                    if (!string.IsNullOrEmpty(col1))
                    {
                        ...
                        if (!string.IsNullOrEmpty(col6))//岗位
                        {
                            var depart = departs.FirstOrDefault(e => e.DepartName == col6);
                            if (depart != null)
                            {
                        ...
                        if (!string.IsNullOrEmpty(col7))//岗位
                        {
                            var post = posts.FirstOrDefault(e => e.WorkPostName == col7);
                            if (post != null)
                            {
                        ...
                        if (!string.IsNullOrEmpty(col8))//特岗证书
                        {
                            personQuality.CertificateName = col8;
                        }
                        if (!string.IsNullOrEmpty(col9))//证书编号
                        {
                            personQuality.CertificateNo = col9;
                        }
                        if (!string.IsNullOrEmpty(col10))//证书有效期
                        {
                            personQuality.LimitDate = Funs.GetNewDateTime(col10);
                        }
                        if (!string.IsNullOrEmpty(col11))//电话
                        {
                            person.Telephone = col11;
                        }
                        person.PersonId = SQLHelper.GetNewID(typeof(Model.SitePerson_Person));
                        person.IsUsed = true;
                        person.InTime = DateTime.Now;
                        persons.Add(person);
            ...
            if (string.IsNullOrEmpty(errorInfos))
            {
                ...
                for (int i = 0; i < a; i++)
                {
                    ...
                    if (PersonService.GetPersonCountByIdentityCard(persons[i].IdentityCard, Request.Params["ProjectId"]) == null)
                    {
                        ...
                        newPerson.IsUsed = persons[i].IsUsed;
        ...
        protected void PageManager1_CustomEvent(object sender, CustomEventArgs e)
        {
            ...
            {
                string rootPath = Server.MapPath("~/");
                string filePath = Const.ServerPersonTemplateUrl;
