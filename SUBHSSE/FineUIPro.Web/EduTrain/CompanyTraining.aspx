    ...
    <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
        <Items >
            <f:Panel runat="server" ID="panelLeftRegion" RegionPosition="Left" RegionSplit="true" 
                EnableCollapse="true" MinWidth="300px" Title="培训教材库" TitleToolTip="培训教材库" ShowBorder="true"
                ShowHeader="false" AutoScroll="true" BodyPadding="5px" IconFont="ArrowCircleLeft">
                <Items>                    
                    <f:Toolbar ID="Toolbar1" Position="Top" runat="server" ToolbarAlign="Right" >
                        <Items>
                                <f:RadioButtonList runat="server" ID="rblType" AutoPostBack="true" AutoColumnWidth="true"
                                    OnSelectedIndexChanged="rblType_SelectedIndexChanged">
                                    <f:RadioItem Value="0" Text="公司" Selected="true"/>
                                    <f:RadioItem Value="1" Text="项目" />
                                </f:RadioButtonList>
                    ...
                    <f:Tree ID="trCompanyTraining" EnableCollapse="true" ShowHeader="false" Title="培训教材库" MinHeight="420px"
            ...
            <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                Layout="VBox" ShowHeader="false" BodyPadding="5px" IconFont="PlusCircle" Title="教材明细"
