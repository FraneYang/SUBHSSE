...
namespace FineUIPro.Web.EduTrain
{
    public partial class TaskView : PageBase
    {
        ...
        {
            string strSql = @"SELECT TaskItem.TaskItemId,TaskItem.TrainingItemCode,TaskItem.TrainingItemName,TaskItem.AttachUrl
                                    ...
                                    FROM Training_TaskItemSchedule A
                                    WHERE A.TaskItemId=TaskItem.TaskItemID) AS ScheduleTime
                                    FROM Training_TaskItem AS TaskItem
                                    WHERE TaskId=@TaskId ";
