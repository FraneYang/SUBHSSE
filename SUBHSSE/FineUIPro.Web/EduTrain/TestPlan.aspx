<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestPlan.aspx.cs" Inherits="FineUIPro.Web.EduTrain.TestPlan" %>
                ...
                <Columns>                   
                    ...
                    <f:RenderField Width="150px" ColumnID="TestStartTime" DataField="TestStartTime" 
                     ...
                     <f:RenderField Width="550px" ColumnID="WorkPostNames" DataField="WorkPostNames" FieldType="String"
                        HeaderText="考生岗位" HeaderTextAlign="Center" TextAlign="Left" ExpandUnusedSpace="true">
                    </f:RenderField>
