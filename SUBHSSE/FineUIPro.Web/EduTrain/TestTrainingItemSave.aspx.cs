    ...
    public partial class TestTrainingItemSave : PageBase
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (!String.IsNullOrEmpty(this.TrainingItemId))
                {
                    ...
                    if (q != null)
                    {
                        ...
                        this.txtAbstracts.Text = q.Abstracts;
                        this.txtAbstractsEng.Text = q.AbstractsEng;
                        ...
                        this.txtAItemEng.Text = q.AItemEng;
                        this.txtBItemEng.Text = q.BItemEng;
                        this.txtCItemEng.Text = q.CItemEng;
                        this.txtDItemEng.Text = q.DItemEng;
                        this.txtEItemEng.Text = q.EItemEng;

                        this.txtAItemRussian.Text = q.AItemRussian;
                        this.txtBItemRussian.Text = q.BItemRussian;
                        this.txtCItemRussian.Text = q.CItemRussian;
                        this.txtDItemRussian.Text = q.DItemRussian;
                        this.txtEItemRussian.Text = q.EItemRussian;
        ...
        private void SaveData(bool isClosed)
        {
            ...
            Model.Training_TestTrainingItem trainingItem = new Training_TestTrainingItem
            {
                ...
                AbstractsEng = txtAbstractsEng.Text.Trim(),
                AbstractsRussian = txtAbstractsRussian.Text.Trim(),
                ...
                AItemEng = txtAItemEng.Text.Trim(),
                BItemEng = txtBItemEng.Text.Trim(),
                CItemEng = txtCItemEng.Text.Trim(),
                DItemEng = txtDItemEng.Text.Trim(),
                EItemEng = txtEItemEng.Text.Trim(),

                AItemRussian = txtAItemRussian.Text.Trim(),
                BItemRussian = txtBItemRussian.Text.Trim(),
                CItemRussian = txtCItemRussian.Text.Trim(),
                DItemRussian = txtDItemRussian.Text.Trim(),
                EItemRussian = txtEItemRussian.Text.Trim(),
