    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="模拟考试" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="ModelTestRecordId" ForceFit="true"
                EnableColumnLines="true" DataIDField="ModelTestRecordId" AllowSorting="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="120px" ColumnID="TestManName" DataField="TestManName" FieldType="String"
                    ...
                    <f:RenderField Width="100px" ColumnID="QuestionCount" DataField="QuestionCount" FieldType="String"
