    ...
    public partial class TrainRecordEdit : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                var trainRecord = EduTrain_TrainRecordService.GetTrainRecordByTrainRecordId(this.TrainingId);
                if (trainRecord != null)
                {
                ...
                if (thisUnit != null)
                {
                    ...
                    if (thisUnit.UnitId == Const.UnitId_SEDIN || thisUnit.UnitId == Const.UnitId_XJYJ || thisUnit.UnitId == Const.UnitId_7)
                    {                      
        ...
        private void SaveData(string type)
        {
            ...
            if (!string.IsNullOrEmpty(this.TrainingId))
            {
                var getTrain = BLL.EduTrain_TrainRecordService.GetTrainRecordByTrainRecordId(this.TrainingId);
                if (getTrain != null)
                {
