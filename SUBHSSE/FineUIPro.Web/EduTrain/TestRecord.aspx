<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestRecord.aspx.cs" Inherits="FineUIPro.Web.EduTrain.TestRecord" %>
                ...
                <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="考试记录" EnableCollapse="true"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" Position="Top" runat="server">
                            <Items>
                                <f:DropDownList ID="drpUnit" Label="单位" AutoPostBack="true" runat="server"
                                    OnSelectedIndexChanged="TextBox_TextChanged" Width="230px" LabelWidth="50px" LabelAlign="Right">
                                </f:DropDownList>
                                <f:DropDownList ID="drpDepart" Label="部门" AutoPostBack="true" runat="server" Hidden="true"
                                    OnSelectedIndexChanged="TextBox_TextChanged" Width="160px" LabelWidth="50px" LabelAlign="Right">
                                </f:DropDownList>
                                <f:TextBox ID="txtName" runat="server" Label="查询" EmptyText="输入查询条件" AutoPostBack="true"
                                    OnTextChanged="TextBox_TextChanged" Width="160px" LabelWidth="50px" LabelAlign="Right">
                                </f:TextBox>
                                ...
                                <f:DatePicker ID="txtStartDate" runat="server" Width="160px" LabelWidth="50px" LabelAlign="Right" Label="时间"
                                    EnableEdit="false" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                                </f:DatePicker>
                                <f:DatePicker ID="txtEndDate" runat="server" Width="140px" LabelAlign="Right" LabelWidth="30px"
                                    EnableEdit="false" Label="至" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                                </f:DatePicker>
                                <f:CheckBox runat="server" Label="时间空" ID="ckIsNULL" AutoPostBack="true" Hidden="true"
                                    OnCheckedChanged="IsTemp_CheckedChanged" LabelWidth="70px" Width="100px">
                                </f:CheckBox>
        ...
        <f:Menu ID="Menu1" runat="server">
            <f:MenuButton ID="btnMenuView" OnClick="btnMenuView_Click" EnablePostBack="true"
                runat="server" Text="查看" Icon="TableGo">
                     ...
                     <f:MenuButton ID="btnReTest" OnClick="btnReTest_Click" EnablePostBack="true"
                runat="server" Icon="ArrowRefresh" Hidden="true" Text="重新考试">
            </f:MenuButton>
