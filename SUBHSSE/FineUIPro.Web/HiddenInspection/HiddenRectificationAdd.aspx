            ...
            <Rows>
                ...
                <f:FormRow>
                    <Items>
                        ...
                        <f:DatePicker ID="txtRectificationPeriod" runat="server" Label="整改期限" LabelAlign="Right" >
                        </f:DatePicker>
                    </Items>
                </f:FormRow>
                <f:FormRow>
                    <Items>
                        <f:DropDownList runat="server" EnableEdit="true" Label="责任人" ID="drpCheckManName" Required="True" ShowRedStar="true">
                        </f:DropDownList>
                           <f:DatePicker ID="txtCheckTime" runat="server" Label="检查时间" LabelAlign="Right" Required="True" ShowRedStar="true">
                        </f:DatePicker>
                    </Items>
                </f:FormRow>
                <f:FormRow>
