    ...
    public class BaseInfoController : ApiController
    {
        ...
        public Model.ResponeData getWorkPostQuery(string strParam)
        {
            ...
            catch (Exception ex)
            {
                responeData.code = 0;
                responeData.message = ex.Message;
                ErrLogInfo.WriteLog(ex, "WX接口-获取岗位信息", "BaseInfoController.getWorkPostQuery");
            }
        ...
        /// </summary>
        /// <returns></returns>
        public Model.ResponeData getWorkPostQuery(string projectId, string strParam)
        {
            var responeData = new Model.ResponeData();
            try
            {
                responeData.data = APIBaseInfoService.getProjectWorkPost(projectId,strParam);
            }
            catch (Exception ex)
            {
                responeData.code = 0;
        ...
        /// </summary>
        /// <returns></returns>
        public Model.ResponeData getAppPage()
        {
            var responeData = new Model.ResponeData();
            try
            {
                responeData.data = APIBaseInfoService.getAppPage(1);
            }
            catch (Exception ex)
            {
                responeData.code = 0;
