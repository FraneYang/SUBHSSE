    ...
    public class UserController : ApiController
    {
        ...
        public Model.ResponeData postLoginOn([FromBody] Model.UserItem userInfo)
        {
            ...
            catch (Exception ex)
            {
                ...
                ErrLogInfo.WriteLog(ex, "WX接口-登陆", "UserController.postLoginOn");
            }
        ...
        public Model.ResponeData getUserByUserId(string userId)
        {
            ...
            catch (Exception ex)
            {
                responeData.code = 0;
                responeData.message = ex.Message;
                ErrLogInfo.WriteLog(ex, "WX接口-获取用户信息", "UserController.getUserByUserId");
            }
        ...
        public Model.ResponeData getIsMainUnitOrAdmin(string userId)
        {
            ...
            catch (Exception ex)
            {
                responeData.code = 0;
                responeData.message = ex.Message;
                ErrLogInfo.WriteLog(ex, "WX接口-本单位用户或管理员", "UserController.getIsMainUnitOrAdmin");
            }
        ...
        public Model.ResponeData getMenuPowerList(string userId, string projectId)
        {
            ...
            catch (Exception ex)
            {
                responeData.code = 0;
                responeData.message = ex.Message;
                ErrLogInfo.WriteLog(ex, "WX接口-获取当前用户菜单权限", "UserController.getMenuPowerList");
            }
        ...
        public Model.ResponeData getIsHaveButtonPower(string userId, string menuId, string projectId, string buttonName)
        {
            ...
            catch (Exception ex)
            {
                responeData.code = 0;
                responeData.message = ex.Message;
                ErrLogInfo.WriteLog(ex, "WX接口-获取是否有按钮权限", "UserController.getIsHaveButtonPower");
            }
