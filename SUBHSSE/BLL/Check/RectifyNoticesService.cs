...
namespace BLL
{
    ...
    public static class RectifyNoticesService
    {
        ...
        public static void AddRectifyNotices(Model.Check_RectifyNotices rectifyNotice)
        {
            ...
            db.SubmitChanges();
            ////增加一条编码记录
            CodeRecordsService.InsertCodeRecordsByMenuIdProjectIdUnitId(Const.ProjectRectifyNoticeMenuId, rectifyNotice.ProjectId, rectifyNotice.UnitId, rectifyNotice.RectifyNoticesId, rectifyNotice.CheckedDate);
        }
