...
namespace BLL
{
    ...
    public static class APIMeetingService
    {
        ...
        public static List<Model.MeetingItem> getMeetingByProjectIdStates(string projectId, string meetingType,string states, int pageIndex)
        {
            using (Model.SUBHSSEDB db = new Model.SUBHSSEDB(Funs.ConnString))
            {
                IQueryable<Model.MeetingItem> getMeetItemData;
                if (meetingType == "C")
                {
                    getMeetItemData = from x in db.Meeting_ClassMeeting
                ...
                {
                    getMeetItemData = from x in db.Meeting_WeekMeeting
                                      where x.ProjectId == projectId
                                      && (states == null || (states == "0" && (x.States == "0" || x.States == null)) || (states == "1" && (x.States == "1" || x.States == "2")))
                ...
                {
                    getMeetItemData = from x in db.Meeting_MonthMeeting
                                      where x.ProjectId == projectId
                                      && (states == null || (states == "0" && (x.States == "0" || x.States == null)) || (states == "1" && (x.States == "1" || x.States == "2")))
                ...
                {
                    getMeetItemData = from x in db.Meeting_SpecialMeeting
                                      where x.ProjectId == projectId
                                      && (states == null || (states == "0" && (x.States == "0" || x.States == null)) || (states == "1" && (x.States == "1" || x.States == "2")))
                ...
                {
                    getMeetItemData = from x in db.Meeting_AttendMeeting
                                      where x.ProjectId == projectId
                                      && (states == null || (states == "0" && (x.States == "0" || x.States == null)) || (states == "1" && (x.States == "1" || x.States == "2")))
                ...
                getMeetingCount = getMeetItemData.Count();
                ...
                else
                {
                    if (pageIndex > 0)
                    {
                        return getMeetItemData.Skip(Funs.PageSize * (pageIndex - 1)).Take(Funs.PageSize).ToList();
                    }
                    else
                    {
                        return getMeetItemData.ToList();
                    }
                }
            }
        }
            ...
            using (Model.SUBHSSEDB db = new Model.SUBHSSEDB(Funs.ConnString))
            {
                ...
                if (meeting.MeetingType == "C")
                {
                    ...
                    if (updateMeet == null)
                    {
                        ...
                        db.SubmitChanges();
                        ////增加一条编码记录
                        BLL.CodeRecordsService.InsertCodeRecordsByMenuIdProjectIdUnitId(BLL.Const.ProjectClassMeetingMenuId, newClassMeeting.ProjectId, null, newClassMeeting.ClassMeetingId, newClassMeeting.CompileDate);
                    }
                    else
                    {
                        updateMeet.UnitId = newClassMeeting.UnitId;
                        updateMeet.TeamGroupId = newClassMeeting.TeamGroupId;
                        updateMeet.ClassMeetingCode = newClassMeeting.ClassMeetingCode;
                        ...
                        updateMeet.CompileDate = newClassMeeting.CompileDate;
                        ...
                        updateMeet.AttentPersonNum = newClassMeeting.AttentPersonNum;
