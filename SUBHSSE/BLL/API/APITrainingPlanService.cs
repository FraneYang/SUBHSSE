...
namespace BLL
{
    public static class APITrainingPlanService
    {
        ...
        public static int getTrainingPlanListCount
        {
            get;
            set;
        }
        ...
        /// <returns></returns>
        public static List<Model.TrainingPlanItem> getTrainingPlanListByProjectIdTrainTypeIdTrainStates(string projectId, string trainTypeId, string states, int pageIndex)
        {
            using (Model.SUBHSSEDB db = new Model.SUBHSSEDB(Funs.ConnString))
            {
                var getData = from x in db.Training_Plan
                              where (x.ProjectId == projectId || (projectId == null && x.ProjectId == null)) && (x.States == states || states == null) && x.TrainTypeId == trainTypeId
                ...
                getTrainingPlanListCount = getData.Count();
