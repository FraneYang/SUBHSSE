...
namespace BLL
{
    ...
    public static class EduTrain_TrainRecordDetailService
    {
        ...
        public static void AddTrainDetail(Model.EduTrain_TrainRecordDetail trainDetail)
        {
            ...
            var rainRecord = EduTrain_TrainRecordService.GetTrainRecordByTrainRecordId(trainDetail.TrainingId);
            if (rainRecord != null)
            {
        ...
        public static void DeleteTrainDetailByTrainDetail(string trainDetailId)
        {
            ...
            if (trainDetails != null)
            {
                ...
                var rainRecord = EduTrain_TrainRecordService.GetTrainRecordByTrainRecordId(trainDetails.TrainingId);
                if (rainRecord != null)
                {
                    rainRecord.TrainPersonNum -= 1;
