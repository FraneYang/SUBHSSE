...
namespace BLL
{
    ...
    public static class EduTrain_TrainRecordService
    {
        ...
        /// 根据教育培训主键获取教育培训信息
        /// </summary>
        /// <param name="TrainRecordId">教育培训主键</param>
        /// <returns>教育培训信息</returns>
        public static Model.EduTrain_TrainRecord GetTrainRecordByTrainRecordId(string trainRecordId)
        {
            return  Funs.DB.EduTrain_TrainRecord.FirstOrDefault(x=> x.TrainingId == trainRecordId);
        }
