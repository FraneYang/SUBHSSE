    ...
    public static class TestTrainingItemService
    {
        ...
        public static void AddTestTrainingItem(Model.Training_TestTrainingItem TestTrainingItem)
        {
            ...
            Model.Training_TestTrainingItem newTestTrainingItem = new Model.Training_TestTrainingItem
            {
                ...
                AbstractsEng = TestTrainingItem.AbstractsEng,
                AbstractsRussian = TestTrainingItem.AbstractsRussian,
                ...
                AItemEng = TestTrainingItem.AItemEng,
                BItemEng = TestTrainingItem.BItemEng,
                CItemEng = TestTrainingItem.CItemEng,
                DItemEng = TestTrainingItem.DItemEng,
                EItemEng = TestTrainingItem.EItemEng,

                AItemRussian = TestTrainingItem.AItemRussian,
                BItemRussian = TestTrainingItem.BItemRussian,
                CItemRussian = TestTrainingItem.CItemRussian,
                DItemRussian = TestTrainingItem.DItemRussian,
                EItemRussian = TestTrainingItem.EItemRussian,
        ...
        public static void UpdateTestTrainingItem(Model.Training_TestTrainingItem TestTrainingItem)
        {
            ...
            if (newTestTrainingItem != null)
            {
                ...
                newTestTrainingItem.AbstractsEng = TestTrainingItem.AbstractsEng;
                newTestTrainingItem.AbstractsRussian = TestTrainingItem.AbstractsRussian;
                ...
                newTestTrainingItem.AItemEng = TestTrainingItem.AItemEng;
                newTestTrainingItem.BItemEng = TestTrainingItem.BItemEng;
                newTestTrainingItem.CItemEng = TestTrainingItem.CItemEng;
                newTestTrainingItem.DItemEng = TestTrainingItem.DItemEng;
                newTestTrainingItem.EItemEng = TestTrainingItem.EItemEng;

                newTestTrainingItem.AItemRussian = TestTrainingItem.AItemRussian;
                newTestTrainingItem.BItemRussian = TestTrainingItem.BItemRussian;
                newTestTrainingItem.CItemRussian = TestTrainingItem.CItemRussian;
                newTestTrainingItem.DItemRussian = TestTrainingItem.DItemRussian;
                newTestTrainingItem.EItemRussian = TestTrainingItem.EItemRussian;
