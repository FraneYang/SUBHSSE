...
namespace BLL
{
   public static class WorkPostService
   {
       ...
       public static void InitWorkPostDropDownList(FineUIPro.DropDownList dropName, bool isShowPlease)
       {
        ...
        public static void InitWorkPostDropDownList(FineUIPro.DropDownList dropName, string projectId, string strParam, bool isShowPlease)
       {
           dropName.DataValueField = "BaseInfoId";
           dropName.DataTextField = "BaseInfoName";
           dropName.DataSource = BLL.APIBaseInfoService.getProjectWorkPost( projectId,  strParam);
           dropName.DataBind();
           if (isShowPlease)
           {
               Funs.FineUIPleaseSelect(dropName);
