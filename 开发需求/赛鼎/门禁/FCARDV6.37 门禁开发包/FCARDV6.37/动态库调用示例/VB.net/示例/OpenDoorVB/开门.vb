...
Public Class 开门
    ...
    Private Sub OpenDoor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '初始化命令操作对象
    ...
    Private Sub btnOpenDoor_Click(sender As Object, e As EventArgs) Handles btnOpenDoor.Click
        '创建开门数组对象，最大4门，true为开门
        Dim doors As Boolean() = New Boolean(3) {True, True, False, False} '开，开，关，关』
        mIO.Command(GetConnectInfo(), "OpenRelay", doors) '开门命令
    End Sub
...
#Region "事件"
    ...
    Private Sub _CommandAchieve(oInfo As ConnectInfo, iCommandCode As Integer, oValue As Object)
        If iCommandCode = FCardCDrive.ConnectMain.eCommandCode.cmdOpenRelay Then
