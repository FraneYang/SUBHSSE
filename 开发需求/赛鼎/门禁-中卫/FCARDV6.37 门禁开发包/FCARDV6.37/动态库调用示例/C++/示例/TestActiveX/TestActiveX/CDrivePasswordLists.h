// CDrivePasswordLists.h : 由 Microsoft Visual C++ 创建的 ActiveX 控件包装器类的声明
...
class CDrivePasswordLists : public COleDispatchDriver
{
public:
	CDrivePasswordLists() {}		// 调用 COleDispatchDriver 默认构造函数
	CDrivePasswordLists(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CDrivePasswordLists(const CDrivePasswordLists& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
