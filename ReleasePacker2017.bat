...
REM 源代码附件文件夹
set FileUpload=%PROJECT_SRC%\SUBHSSE\FineUIPro.Web\FileUpload
...
del %RELEASE_PUBLISHER_ROOT%\*.config /s /f
del %RELEASE_PUBLISHER_ROOT%\*.ico /s /f
del %RELEASE_PUBLISHER_ROOT%\*.jpg /s /f
