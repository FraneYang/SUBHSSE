...
UPDATE Information_DrillConductedQuarterlyReport SET UpState='2'
WHERE UnitId='b4f3d912-ca6d-440c-a8d7-bc6a5d5a1f84' AND YearId=2015 AND Quarter=4
...
ALTER TABLE Information_UrgeReport ADD IsCancel bit null
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'是否取消催报' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Information_UrgeReport', @level2type=N'COLUMN',@level2name=N'IsCancel'
GO
