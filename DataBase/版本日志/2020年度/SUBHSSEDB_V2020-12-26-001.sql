...
ALTER TABLE Training_TestRecord ADD UnitId NVARCHAR(50) NULL
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'考生单位id' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Training_TestRecord', @level2type=N'COLUMN',@level2name=N'UnitId'
GO
UPDATE Training_TestRecord SET UnitId=(SELECT UnitId FROM SitePerson_Person A WHERE Training_TestRecord.TestManId =A.PersonId)
GO

UPDATE Sys_MenuProjectA SET MenuName='隐患整改单' where MenuId='C3B6B222-44DC-46F3-B783-B1FC0F743C48'
GO
ALTER TABLE Check_CheckSpecialDetail ADD DataId nvarchar(500) null
go
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'下发单据ID' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Check_CheckSpecialDetail', @level2type=N'COLUMN',@level2name=N'DataId'
GO
ALTER TABLE Check_CheckSpecialDetail ADD DataType nvarchar(50) null
go
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'下发单据类型' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Check_CheckSpecialDetail', @level2type=N'COLUMN',@level2name=N'DataType'
GO
alter table [dbo].[Check_CheckSpecialDetail] add SortIndex int null
GO
ALTER TABLE Check_CheckSpecialDetail ADD HiddenHazardType nvarchar(500) null
go