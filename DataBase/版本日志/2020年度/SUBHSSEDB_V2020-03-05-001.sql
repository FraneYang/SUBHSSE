ALTER TABLE Sys_User ADD OpenId NVARCHAR(100) NULL
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'微信OpenId' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Sys_User', @level2type=N'COLUMN',@level2name=N'OpenId'
GO

ALTER TABLE Base_Unit ADD SupUnitId NVARCHAR(50) NULL
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'上级单位' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Base_Unit', @level2type=N'COLUMN',@level2name=N'SupUnitId'
GO
