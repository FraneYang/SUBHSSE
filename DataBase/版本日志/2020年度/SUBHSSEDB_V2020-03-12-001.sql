ALTER TABLE Base_SpecialEquipment ADD SpecialEquipmentType varchar(2) null
go
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'类型（1、特种设备2、大型机具设备3、特殊机具设备4、其他）' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Base_SpecialEquipment', @level2type=N'COLUMN',@level2name=N'SpecialEquipmentType'
GO
...
ALTER TABLE Check_PauseNotice ADD ProjectHeadConfirmId NVARCHAR(50) NULL
GO
...
ALTER TABLE SitePerson_PersonInOut ADD ProjectHeadConfirmId NVARCHAR(50) NULL
GO

ALTER TABLE HSSESystem_HSSEManageItem ALTER COLUMN Duty  NVARCHAR(500) NULL
GO
